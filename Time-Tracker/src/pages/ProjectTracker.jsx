    ...
    return (
        <div className="projectTracker">
            ...
            <div className="projectTracker-page">
                ...
                <div className="cards">
                    <FeatureCard title="Hourly Tracking" icon="⏱️" path="/clients/hourly" state={{ mode: "hourly" }} /> {/* Ignore the emojis, also placeholders */}
                    <FeatureCard title="Reporting" icon="📈" path="/reporting"/> {/*Unecessary tab but will be here for future use (powerBI stuff) */}
                    <FeatureCard title="Contracts" icon="📄" path="/clients/contracts" state={{ mode: "contracts" }} />
